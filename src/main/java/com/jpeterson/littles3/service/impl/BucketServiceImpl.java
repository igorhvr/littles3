...
import com.jpeterson.littles3.service.BucketService;
...
public class BucketServiceImpl implements BucketService {
	...
	public Bucket load(String bucket) throws DataAccessException {
		return bucketDao.loadBucket(bucket);
	}

	public void store(Bucket bucket) throws DataAccessException {
		Acp acp;
	...
	public void remove(Bucket bucket) throws DataAccessException {
